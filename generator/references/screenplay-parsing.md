...
- 原有台词和旁白与动作／心理叙述分开记录；不把后者自动变成V.O.。原文分镜编号和换行不作为Clip切割依据，明确剧情转场仍保留。
...
完成门槛：每个事实性 Beat 可定位到原文；所有关键状态变化和对白均有承载；ID 唯一且续批稳定；时间关系无因果循环。随后完善 [资产绑定](asset-binding.md)，再读 [时间线与声音](timing-and-audio.md)，先估时再分组和规划镜头。
